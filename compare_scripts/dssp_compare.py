...
list_1sug_dis_AD_alt = open (file_path[7].strip(),'r').readlines() #WPD closed, a7 disordered, AD present
list_1sug_dis_AD_alt2 = open (file_path[8].strip(),'r').readlines() #WPD closed, a7 disordered, AD present
list_AD_dis_7 = open (file_path[9].strip(),'r').readlines() #WPD open/closed, a7 disordered, AD present
list_AD_dis_9 = open (file_path[10].strip(),'r').readlines() #WPD open/closed, a7 disordered, AD present
list_AD_dis_11 = open (file_path[11].strip(),'r').readlines() #WPD open/closed, a7 disordered, AD present
list_AD_dis_alt = open (file_path[12].strip(),'r').readlines() #WPD open/closed, a7 disordered, AD present
...
AD_alt_alpha_per, AD_alt_struct_per, AD_alt_alpha_mean, AD_alt_struct_mean, AD_alt_alpha_sem, AD_alt_struct_sem = mdfunc.per_helx(list_AD_dis_alt, False)
...
ax1.plot(num, sug_AD_alpha_mean, label='AD', linestyle = 'dashed', color = 'blue')
...
ax1.plot(num, sug_AD_alpha_mean, label='AD', linestyle = 'dashed', color = 'blue')
ax1.fill_between(num, sug_AD_alpha_mean - sug_AD_alpha_sem, sug_AD_alpha_mean + sug_AD_alpha_sem, alpha=0.2, facecolor = 'blue', edgecolor = 'blue')
ax1.plot(num, BBR_a7_alpha_mean, label='BBR', linestyle = 'dotted', color = 'blue')
...
ax1.set_ylim(0,100)
ax1.plot(num, sug_AD_alpha_mean, label='AD', linestyle = 'dashed', color = 'blue')
ax1.fill_between(num, sug_AD_alpha_mean - sug_AD_alpha_sem, sug_AD_alpha_mean + sug_AD_alpha_sem, alpha=0.3, facecolor = 'blue', edgecolor = 'blue')
ax1.plot(num, BBR_a7_alpha_mean, label='BBR', linestyle = 'dotted', color = 'purple')
ax1.fill_between(num, BBR_a7_alpha_mean - BBR_a7_alpha_sem, BBR_a7_alpha_mean + BBR_a7_alpha_sem, alpha=0.3, facecolor = 'purple', edgecolor = 'purple')
ax1.plot(num, AD_BBR_alpha_mean, label='AD BBR Combo', linestyle = 'dotted', color = 'green')
ax1.fill_between(num, AD_BBR_alpha_mean - AD_BBR_alpha_sem, AD_BBR_alpha_mean + AD_BBR_alpha_sem, alpha=0.3, facecolor = 'green', edgecolor = 'green')
ax1.set_xlabel('Residue ID')
leg = ax1.legend()
...
ax1.plot(time_a7_AD, alpha_a7_AD_avg, label='AD loc4', color = 'lightblue')
ax1.plot(time_1sug_AD, alpha_1sug_AD_avg, label='AD loc2', color = 'blue')
